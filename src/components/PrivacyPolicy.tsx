      ...
      <main className="pt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="prose prose-lg max-w-[800px] mx-auto space-y-8">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">2. Verantwortliche Stelle</h2>
              <div className="space-y-4">
                <p>
                ...
                <p>
                  Vertretungsberechtigte Person: Karsten Kreh<br />
                  E-Mail: <a href="mailto:info@safina.ai" className="text-teal-600 hover:text-teal-700">info@safina.ai</a>
                </p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-semibold mt-8">3. Ihre Rechte</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">4. Übersicht der Verarbeitungen</h2>
              <div className="space-y-4">
                <h3 className="text-xl font-semibold">Arten der verarbeiteten Daten</h3>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold">Kategorien betroffener Personen</h3>
                <ul className="list-disc pl-6 space-y-2">
                ...
                <h3 className="text-xl font-semibold">Zwecke der Verarbeitung</h3>
                <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">5. Maßgebliche Rechtsgrundlagen</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">6. Sicherheitsmaßnahmen</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">7. Übermittlung von personenbezogenen Daten</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">8. Internationale Datentransfers</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">9. Allgemeine Informationen zur Datenspeicherung und Löschung</h2>
              <div className="space-y-4">
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li><strong>Recht auf Löschung und Einschränkung der Verarbeitung:</strong> Sie haben nach Maßgabe der gesetzlichen Vorgaben das Recht, zu verlangen, dass Sie betreffende Daten unverzüglich gelöscht werden, bzw. alternativ nach Maßgabe der gesetzlichen Vorgaben eine Einschrnkung der Verarbeitung der Daten zu verlangen.</li>
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">11. Geschäftliche Leistungen</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">12. Registrierung, Anmeldung und Nutzerkonto</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">13. Kontakt- und Anfrageverwaltung</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">14. Newsletter und elektronische Benachrichtigungen</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">15. Werbliche Kommunikation via E-Mail, Post, Fax oder Telefon</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">16. Webanalyse, Monitoring und Optimierung</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">17. Onlinemarketing</h2>
              <div className="space-y-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mt-8">18. Plug-ins und eingebettete Funktionen sowie Inhalte</h2>
              <div className="space-y-4">
